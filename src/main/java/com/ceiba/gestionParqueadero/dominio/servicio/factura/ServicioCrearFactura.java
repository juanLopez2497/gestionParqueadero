...
public class ServicioCrearFactura {
	...
	private final IFactura facturaRepository;
	private final IActividadRepository actividadRepository; 
	
	public ServicioCrearFactura(IFactura factura, IActividadRepository actividadRepository){
		this.facturaRepository=factura;
		this.actividadRepository=actividadRepository;
	}
	
	public FacturaResumen crearFactura(FacturaInicializar facturaInicializar){
		ActividadResumen actividadResumen=actividadRepository.buscarActividadById(facturaInicializar.getId());
		double pagoParcial=0;
		double totalAumentos=0;
		double totalRebaja=0;
		...
		FacturaResumen facturaToPersist= new FacturaResumen(actividadResumen.getIdActRegistro(),
			...
			return facturaRepository.crearFacturaRegistro(facturaToPersist);
	}
